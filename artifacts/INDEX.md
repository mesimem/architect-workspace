...
|---|---|---|---|---|
| Week 1 | Build Your First Claude Code Project — claude-standards.md | [`claude-standards.md`](./week-01/claude-standards.md) | Own project | 6 KB |
| Week 2 | Implementation Task: Build Two More Skills — SKILL.md | [`skill.md`](./week-02/skill.md) | Own project | 5 KB |
| Week 3 | Build Your First AI Workflow — SETUP-NOTES.pdf | [`setup-notes.pdf`](./week-03/setup-notes.pdf) *(held on platform)* | U.S.-based Full-Service Travel Agency Platform | 106 KB |
